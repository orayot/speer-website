...
const Hero = () => (<div className='cf'>
  <div className='w-100 w-50-ns fl-ns'>
    <div className="w-80 center mt2 mt6-ns pl0 pl4-ns">
      <div className='f3 f1-ns'>Customers are immune to sales emails and texts.</div>
      <div className='f4 f3-ns lighter-gray'>
        <p>Speer helps you observe a customer’s body language & change your message accordingly.</p>
